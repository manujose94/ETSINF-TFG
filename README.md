...
___TFG DOCUMENTATION__
=================

<!--ts-->
   * [TFG ETSINF UPV](#BANCALET-VIRTUAL-API-REST-DOCUMENTATION)
...
=================
This project content a difrent folder content, in order to sperate teoric content and practical content.
-----
**Tree Folders**
- Documents
 ```
...
- Projects
    ...
    ```` Content mfont material to the impmented projects in tfg. ````
